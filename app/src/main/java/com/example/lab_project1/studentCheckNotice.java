...
public class studentCheckNotice extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_check_notice);
        toolbar = (Toolbar)findViewById(R.id.toolbar_student_notice_board);
        setSupportActionBar(toolbar);

        recyclerView = findViewById(R.id.recycle_view_student_notice);
        ...
        db.collection("Notice").orderBy("date" , Query.Direction.DESCENDING).addSnapshotListener(new EventListener<QuerySnapshot>() {
            ...
            public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                if(error!=null)
                {
                    Toast.makeText(studentCheckNotice.this, "Error"+error.getMessage(), Toast.LENGTH_SHORT).show();
                    return;
                }
                noticeModels.clear();
