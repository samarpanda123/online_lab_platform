...
public class Create_lab_test extends AppCompatActivity {


    Button Selectfile, upload, remove;
    Uri fileURLs; // URi s are URLS that are meant for local storage
    FirebaseStorage storage;   // used to upload files in storage
    FirebaseDatabase database;  // used to store urls for uploaded files
    TextView notification;
    EditText course_id, course_name,  Lab_test_name, Lab_test_des, start_date, end_date, start_time, end_time;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Lab_test_des = findViewById(R.id.labtest_desp);
        notification = findViewById(R.id.notification);
        Lab_test_name = findViewById(R.id.labtest_name);
        start_date = findViewById(R.id.start_date);
        end_date = findViewById(R.id.end_date);
        start_time= findViewById(R.id.start_time);
        end_time = findViewById(R.id.end_time);
        submit_btn = findViewById(R.id.create_labtest);
        ...
        btn_start_time.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new TimePickerDialog(Create_lab_test.this, onTimeSetListener, calendar.get(Calendar.HOUR_OF_DAY), calendar.get(Calendar.MINUTE), false).show();
            }
        });
        ...
        btn_start_date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog( Create_lab_test.this, onDateSetListener, calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH), calendar.get(Calendar.DAY_OF_MONTH)).show();
            }
        });
        ...
        Selectfile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(ContextCompat.checkSelfPermission(Create_lab_test.this, Manifest.permission.READ_EXTERNAL_STORAGE)== PackageManager.PERMISSION_GRANTED){
                    Select_an_Item();
                }
                else
                    ActivityCompat.requestPermissions( Create_lab_test.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, 9);
            }
        ...
        submit_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String A_Assign_name = Lab_test_name.getText().toString();
                String A_Assign_desp = Lab_test_des.getText().toString();
                ...
                if(new_url.length()>0){
                    ...
                    userMap.put("Labtest_Name", A_Assign_name);
                    userMap.put("Labtest_Description", A_Assign_desp);
                    ...
                    userMap.put("Start_Date", A_startdate);
                    userMap.put("End_Date", A_enddate);
                    userMap.put("Start_Time", A_startdate);
                    userMap.put("End_Time", A_endtime);
                }

                DocumentReference ref = db.collection("Lab_test").document();
                uid = ref.getId();
                ref.set(userMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        if(task.isComplete())
                        {
                            Toast.makeText(Create_lab_test.this, "Lab test is created successfully", Toast.LENGTH_SHORT).show();
                        }
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(Create_lab_test.this, "There is an error in creating Lab test"+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
...
//                    @Override
//                    public void onComplete(@NonNull Task<Void> task) {
//                        Toast.makeText(Create_lab_test.this, "Assignment is created Successfully!!...", Toast.LENGTH_SHORT).show();
//                    }
//                }).addOnFailureListener(new OnFailureListener() {
//                    @Override
//                    public void onFailure(@NonNull Exception e) {
//                        Toast.makeText(Create_lab_test.this, "Error: Assignment not created due to some problem!!...", Toast.LENGTH_SHORT).show();
//                    }
//                });
            }
        });
    ...
    private void uploadFile(Uri fileURLs) {
        ...
        String Name_Assign = Lab_test_name.getText().toString().trim();
        ...
        storageReference.child("Lab_test").child(filename)
...
//                            Toast.makeText(Create_lab_test.this, "File is successfully Uploaded", Toast.LENGTH_LONG).show();
//                        }
//                        else
//                            Toast.makeText(Create_lab_test.this, "Error: File Uploading Failed!!...", Toast.LENGTH_LONG).show();
//                    }
//                }) ;
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(Create_lab_test.this, "Error: Failed to Upload!!...", Toast.LENGTH_SHORT).show();
            }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if( requestCode == 9 && grantResults[0] == PackageManager.PERMISSION_GRANTED){
            ...
            Toast.makeText(Create_lab_test.this, "Please Provide Permission To Select any File..", Toast.LENGTH_SHORT).show();
    }
